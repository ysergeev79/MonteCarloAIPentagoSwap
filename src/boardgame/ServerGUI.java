...
public class ServerGUI extends JFrame implements BoardPanel.BoardPanelListener {
    ...
    protected static final String[] PLAYER_CLASSES = { "pentago_swap.RandomPentagoPlayer", "student_player.StudentPlayer", "student_player.AlphaPlayer", "student_player.Guillaume", "student_player.Rush" };
